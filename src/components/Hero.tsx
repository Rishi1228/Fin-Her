    ...
    <section className="bg-gradient-to-r from-bloom-softPurple to-white py-6 sm:py-8 md:py-10 overflow-hidden">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row items-center gap-6 md:gap-8">
          ...
          <div className="md:w-1/2 space-y-3 sm:space-y-4 text-center md:text-left">
          ...
          <div className="md:w-1/2 mt-6 md:mt-0 flex justify-center">
            <div className="relative w-full max-w-md md:max-w-full aspect-[4/5]">
              {/* Decorative Circles */}
              <div className="absolute -top-4 -left-4 w-16 h-16 sm:w-20 sm:h-20 bg-bloom-coral rounded-full opacity-50 z-0"></div>
              <div className="absolute -bottom-4 -right-4 w-20 h-20 sm:w-24 sm:h-24 bg-bloom-teal rounded-full opacity-30 z-0"></div>
